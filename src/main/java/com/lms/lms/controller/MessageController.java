...
public class MessageController {
    ...
    public String reply(@PathVariable("id") Long id, Model model) {
        Message original = messageService.findById(id).orElseThrow();
        model.addAttribute("users", userService.findAll());
        model.addAttribute("replyTo", original.getSender());
        model.addAttribute("replySubject", "Re: " + original.getSubject());
