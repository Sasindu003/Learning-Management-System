...
public class StudentController {
    ...
    public String grades(Model model, Authentication auth,
        ...
        User student = userService.findByUsername(auth.getName()).orElseThrow();
        List<com.lms.lms.model.StudentGrade> gradeList;
        if (term != null && !term.isEmpty()) {
            gradeList = studentGradeService.findByStudentAndTerm(student, term);
        } else {
            gradeList = studentGradeService.findByStudent(student);
        }
        ...
        model.addAttribute("allGrades", studentGradeService.findByStudent(student));
    ...
    public String announcements(Model model) {
        model.addAttribute("announcements", announcementService.findByTarget(com.lms.lms.model.Announcement.TargetAudience.STUDENTS));
